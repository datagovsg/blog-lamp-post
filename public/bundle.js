...
var SimplePie = function (_Chart) {
  ...
  function SimplePie(props) {
    _classCallCheck$1(this, SimplePie);

    var _this = _possibleConstructorReturn$1(this, (SimplePie.__proto__ || Object.getPrototypeOf(SimplePie)).call(this));
...
var SimpleBar = function (_Chart) {
  ...
  function SimpleBar(props) {
    _classCallCheck$3(this, SimpleBar);

    var _this = _possibleConstructorReturn$2(this, (SimpleBar.__proto__ || Object.getPrototypeOf(SimpleBar)).call(this));
...
var GroupedBar = function (_Chart) {
  ...
  function GroupedBar(props) {
    _classCallCheck$4(this, GroupedBar);

    var _this = _possibleConstructorReturn$3(this, (GroupedBar.__proto__ || Object.getPrototypeOf(GroupedBar)).call(this));
...
var StackedBar = function (_Chart) {
  ...
  function StackedBar(props) {
    _classCallCheck$5(this, StackedBar);

    var _this = _possibleConstructorReturn$4(this, (StackedBar.__proto__ || Object.getPrototypeOf(StackedBar)).call(this));
...
var MultipleLine = function (_Chart) {
  _inherits$5(MultipleLine, _Chart);
  ...
  function MultipleLine(props) {
    _classCallCheck$6(this, MultipleLine);

    var _this = _possibleConstructorReturn$5(this, (MultipleLine.__proto__ || Object.getPrototypeOf(MultipleLine)).call(this));
...
var CustomTimeScale = function (_Plottable$Scales$Tim) {
  _inherits$6(CustomTimeScale, _Plottable$Scales$Tim);

  function CustomTimeScale() {
    _classCallCheck$7(this, CustomTimeScale);

    return _possibleConstructorReturn$6(this, (CustomTimeScale.__proto__ || Object.getPrototypeOf(CustomTimeScale)).apply(this, arguments));
  }

  _createClass$4(CustomTimeScale, [{
    ...
    value: function _expandSingleValueDomain(singleValueDomain) {
      ...
      return _get(CustomTimeScale.prototype.__proto__ || Object.getPrototypeOf(CustomTimeScale.prototype), '_expandSingleValueDomain', this).call(this, _singleValueDomain);
    }
  }]);
...
function getCustomTimeAxisConfigs(type) {
  switch (type) {
    ...
    case 'financial_half_year':
      return [].concat(_toConsumableArray$1(halfYearConfigs()), _toConsumableArray$1(yearConfigs()));
    case 'quarter':
    case 'financial_quarter':
      return [].concat(_toConsumableArray$1(quarterConfigs()), _toConsumableArray$1(yearConfigs()));
    case 'month':
      return [].concat(_toConsumableArray$1(monthConfigs()), _toConsumableArray$1(yearConfigs()));
    case 'week':
      return [].concat(_toConsumableArray$1(weekConfigs()), _toConsumableArray$1(yearConfigs()));
    case 'date':
      return [].concat(_toConsumableArray$1(dateConfigs()), _toConsumableArray$1(monthConfigs()), _toConsumableArray$1(yearConfigs()));
    case 'date_time':
      return [].concat(_toConsumableArray$1(dateTimeConfigs()), _toConsumableArray$1(dateConfigs()), _toConsumableArray$1(monthConfigs()), _toConsumableArray$1(yearConfigs()));
    case 'time':
      return timeConfigs();
  }
}
...
var DatagovsgLine = function (_MultipleLine) {
  _inherits(DatagovsgLine, _MultipleLine);

  function DatagovsgLine(props) {
    _classCallCheck(this, DatagovsgLine);
    ...
    var _this6 = _possibleConstructorReturn(this, (DatagovsgLine.__proto__ || Object.getPrototypeOf(DatagovsgLine)).call(this, props));
...
function generateLayer(roadId) {
  ...
  layer.loadGeoJson('data/lampPost/' + roadId + '.json', null, function (features) {
    var midPoint = Math.floor(features.length / 2);
...
function updateChart(roadId) {
  return window.fetch('data/histogram/' + roadId + '.json').then(function (res) {
...
var chart = new DatagovsgSimpleBar({
  data: [],
  xLabel: 'Meters',
  yLabel: 'Frequency'
});
...
select.addEventListener('change', function (event) {
  ...
  updateChart(selected).then(function (series) {
    return chart.update({ data: series });
  });
});
